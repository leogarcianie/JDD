...
class RegistroVacunaWidget extends StatefulWidget {
  const RegistroVacunaWidget({Key? key}) : super(key: key);

  @override
  _RegistroVacunaWidgetState createState() => _RegistroVacunaWidgetState();
}
...
class _RegistroVacunaWidgetState extends State<RegistroVacunaWidget> {
  ...
  void initState() {
    ...
    _model.nomVacunaController ??= TextEditingController();
